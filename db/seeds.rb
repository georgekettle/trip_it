...
user = User.create(email: "george.kettle@icloud.com", password: 'secret', password_confirmation: 'secret', username: 'george.kettle')
user_2 = User.create(email: "emma.lyons@icloud.com", password: 'secret', password_confirmation: 'secret', username: 'emma.lyons')
